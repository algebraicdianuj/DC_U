...
def main():
    parser = argparse.ArgumentParser(description='forget seperation')
    ...
    seeder=42
    ipc=10
    choice=  args.c    # 'arbitrary_uniform' or 'classwise' or 'arbitrary_partial' 'mia_protection'
