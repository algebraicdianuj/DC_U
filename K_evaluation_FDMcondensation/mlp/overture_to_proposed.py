...
def main():
    ...
    num_classes = 10
    batch_real = 5000
    split_ratio = args.s_r   # forget-retain split ratio
    n_subclasses= args.n_s   # K-means "K"
    ...
    reduced_imgs,reduced_labs= offline_data_processing(inverted_IMG, inverted_LABEL,  indices_train_wrt_bucket, forget_indices, retain_indices, bucket_labbies, img_real_data_dataset,train_images,train_labels,forget_loader, retain_loader,device, n_subclasses=n_subclasses, num_classes=num_classes, batch_size_bucket=batch_size_bucket,choice=args.c)
    #-------------------------------------------------------------------------------------------------------------------------------------------
