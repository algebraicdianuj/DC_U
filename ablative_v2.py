...
def main(args):
    ...
    free_images , free_labels = torch.cat(target_images), torch.cat(target_labels)
    ...
    save_data(result_directory_path, 'L1_sparsity_ablv2', df, args.model_name, args.exp, choice)
