...
def main():
    ...
    unlearning_metric=measure_unlearning(distilled_net, forget_loader, retain_loader, device)
    ...
    unlearning_metric=measure_unlearning(sparsified_net, forget_loader, retain_loader, device)
