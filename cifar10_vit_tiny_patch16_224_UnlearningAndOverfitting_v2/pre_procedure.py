...
def main():
    ...
    for epochy in range(training_epochs):
        ...
        if epochy % 10 == 0 or epochy == training_epochs-1 or epochy == 0:
            ...
            print('Epoch: {} \tTrain Accuracy: {:.6f}'.format(epochy, train_acc))
    ...
    file_path = os.path.join(result_directory_path, 'stat_vit_tiny_patch16_224_cifar10_'+str(training_epochs)+'epochs.csv')
