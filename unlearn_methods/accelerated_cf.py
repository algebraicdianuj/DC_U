...
class Accelerated_CF_Unlearner:
    def __init__(self, 
                 original_model, 
                 retain_dataloader, 
                 forget_dataset, 
    ...
    def train_per_epoch(self, 
        ...
        return run_ce_loss/len(retain_dataloader), run_distribution_loss/len(retain_dataloader)
    ...
    def train(self, epochs=5, learning_rate=1e-4):
        ...
        for epoch in range(epochs):
            run_ce_loss, run_distribution_loss = self.train_per_epoch(current_model, 
                                                                    main_criterion,
                                                                    loss_transformer,
                                                                    optimizer,
