...
from model.networks import MLP, ConvNet, LeNet, AlexNet, AlexNetBN, VGG11, VGG11BN, ResNet18, ResNet18BN_AP, ResNet18BN
...
def epoch(mode, dataloader, net, optimizer, criterion, do_dsa, dsa_strategy, dsa_param, device):
