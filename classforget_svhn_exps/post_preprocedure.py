...
def main():
    ...
    seeder=42
    ipc=10
    choice= 'classwise'    # 'arbitrary_uniform' or 'classwise' or 'arbitrary_partial' 'mia_protection'
    forgetfull_class=3     #  if choice=='classwise' then this is the class to forget
