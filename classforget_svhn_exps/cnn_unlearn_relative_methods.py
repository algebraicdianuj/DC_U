...
from modular_unlearn.offline_training_cnn import *
...
def main():
    ...
    lr_overture=0.001
    lr_intermediate=0.001
    overture_epochs=10
    beggining_epochs=1
    final_epochs = 10
    intermediate_epochs= 1
    final_thr=25  # intended for blocking the final training in overture, 
    ...
    # count the total number of parameters in combined_model
    total_params = sum(p.numel() for p in combined_model.parameters())
    print("Total number of parameters in combined_model: ", total_params)
    total_params_net= sum(p.numel() for p in net.parameters())
    print("Total number of parameters in net: ", total_params_net)
    #----------------------------------------------------------------------------------------------------------------------------------
    ...
    file_path = os.path.join(result_directory_path,'cnn_modular_unlearning_stats.csv')
    ...
    file_path = os.path.join(result_directory_path,'cnn_retraining_unlearning_stats.csv')
    df.to_csv(file_path, index=False)
    ...
    file_path = os.path.join(result_directory_path,'cnn_catastrophic_unlearning_stats.csv')
    df.to_csv(file_path, index=False)
    ...
    file_path = os.path.join(result_directory_path,'cnn_distillation_unlearning_stats.csv')
    df.to_csv(file_path, index=False)
    ...
    file_path = os.path.join(result_directory_path,'cnn_bad_teacher_distillation_unlearning_stats.csv')
    df.to_csv(file_path , index=False)
    ...
    file_path = os.path.join(result_directory_path,'cnn_sparsification_unlearning_stats.csv')
    df.to_csv(file_path, index=False)
    ...
    file_path = os.path.join(result_directory_path,'cnn_prunning_unlearning_stats.csv')
    df.to_csv(file_path, index=False)
