...
def main(args):
    ...
    condensed_dataset=TensorDatasett(reduced_retain_images, reduced_retain_labels)
    ...
    if do_acatf:
        ...
        unlearner = Accelerated_CF_Unlearner(
                        ...
                        retain_dataloader=condensed_loader,
    ...
    if do_retrain:
        ...
        print('\nRetraining-Unlearning Stats (Condensed): ')
        print('======================================')
        print('mia_score: ', mia_score)
        print('retain_acc: ', retain_acc)
        print('forget_acc: ', forget_acc)
        ...
        save_data(result_directory_path, 'retraining_cond', df, args.model_name, args.exp, choice)
    ...
    if do_CF:
        ...
        print('\nCatastrophic-Forgetting Stats (Condensed): ')
        print('======================================')
        print('mia_score: ', mia_score)
        print('retain_acc: ', retain_acc)
        print('forget_acc: ', forget_acc)
        ...
        save_data(result_directory_path, 'CF_cond', df, args.model_name, args.exp, choice)
    ...
    if do_fisher:
        ...
        naive_net= get_model(args.model_name, args.exp, data_storage, num_classes, device, load=True)
        starting_time = time.time()
        forgot_net=fisher_forgetting(naive_net, 
                                     condensed_loader, 
                                     num_classes, 
                                     device, 
                                     class_to_forget=forgetfull_class if choice=='classwise' else None, 
                                     num_to_forget=None, 
                                     alpha=fisher_alpha)
        ending_time = time.time()
        unlearning_time=ending_time - starting_time
        ...
        print('\nFisher-Forgetting Stats (Condensed): ')
        print('======================================')
        print('mia_score: ', mia_score)
        print('retain_acc: ', retain_acc)
        print('forget_acc: ', forget_acc)
        ...
        save_data(result_directory_path, 'fischerForgetting_cond', df, args.model_name, args.exp, choice)
    ...
    if do_ssd:
        ...
        total_dataset = torch.utils.data.ConcatDataset([forget_loader.dataset, condensed_loader.dataset])
        ...
        print('\nSynaptic-Dampening Stats (Condensed): ')
        print('======================================')
        print('mia_score: ', mia_score)
        print('retain_acc: ', retain_acc)
        print('forget_acc: ', forget_acc)
        ...
        save_data(result_directory_path, 'synaptic_dampening_cond', df, args.model_name, args.exp, choice)
    ...
    if do_ssd_lf:
        ...
        print('\nSynaptic-Dampening-Label Free Stats (Condensed): ')
        print('======================================')
        print('mia_score: ', mia_score)
        print('retain_acc: ', retain_acc)
        print('forget_acc: ', forget_acc)
        ...
        save_data(result_directory_path, 'synaptic_dampening_labelfree_cond', df, args.model_name, args.exp, choice)
    ...
    if do_distillation:
        ...
        starting_time = time.time()
        distilled_net = distillation_unlearning(condensed_loader, 
                                                distill_lr ,
                                                distill_momentum,
        ...
        print('\nDistillation-Unlearning Stats (Condensed): ')
        print('======================================')
        print('mia_score: ', mia_score)
        print('retain_acc: ', retain_acc)
        print('forget_acc: ', forget_acc)
        ...
        save_data(result_directory_path, 'distillation_cond', df, args.model_name, args.exp, choice)
    ...
    if do_scrub:
        ...
        print('\nSCRUB-Unlearning Stats (Codensed): ')
        print('======================================')
        print('mia_score: ', mia_score)
        print('retain_acc: ', retain_acc)
        print('forget_acc: ', forget_acc)
        ...
        save_data(result_directory_path, 'SCRUB_cond', df, args.model_name, args.exp, choice)
    ...
    if do_bad_distillation:
        ...
        print('\nBad Teacher Distillation-Unlearning Stats (Condensed): ')
        print('======================================')
        print('mia_score: ', mia_score)
        print('retain_acc: ', retain_acc)
        print('forget_acc: ', forget_acc)
        ...
        save_data(result_directory_path, 'Bad_distillation_cond', df, args.model_name, args.exp, choice)
    ...
    if do_l1_sparsity:
        ...
        save_data(result_directory_path, 'L1_sparsity_cond', df, args.model_name, args.exp, choice)
    ...
    if do_pruning:
        ...
        save_data(result_directory_path, 'pruning_cond', df, args.model_name, args.exp, choice)
