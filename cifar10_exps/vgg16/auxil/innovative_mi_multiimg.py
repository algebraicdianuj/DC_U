...
def condensive_inversion_multi(directory, net, ref_net, training_images, training_labels, img_shape, num_classes, random_classes, samps_per_class, hidden_size, lr_inverter, inverter_epochs, batch_size, case, device):
    ...
    # inverted_net=InverterResnet18(output_size=img_shape)
    ...
    plot_images_matrix(images_dict, random_classes, figsize=(25, 16),filename=file_path)
