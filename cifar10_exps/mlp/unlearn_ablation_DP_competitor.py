...
def main():
    ...
    combined_model=add_noise(combined_model, forget_loader, criterion, threshold, lambd, device)
    ...
    random_classes=class_sampler(train_loader=img_real_data_loader, samp_num_classes=3)

    condensive_inversion(directory=result_directory_path, 
                        net=combined_model,
                        ref_net=net,
    ...
    unlearning_metric=measure_unlearning(dp_net, forget_loader, retain_loader, device)
