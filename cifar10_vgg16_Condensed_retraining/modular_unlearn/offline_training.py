...
def offline_trainer(new_directory_path,net,img_real_data_loader, img_syn_loader, retain_loader, forget_loader, device, offline_condensation_iterations, final_model_epochs, databank_model_epochs, lr_final, lr_databank,channel, im_size, num_classes):
