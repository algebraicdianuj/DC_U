...
def main():
    ...
    file_path = os.path.join(result_directory_path,'vgg_modular_unlearning_stats.csv')
    ...
    file_path = os.path.join(result_directory_path,'vgg_retraining_unlearning_stats.csv')
    df.to_csv(file_path, index=False)
    ...
    file_path = os.path.join(result_directory_path,'vgg_catastrophic_unlearning_stats.csv')
    df.to_csv(file_path, index=False)
    ...
    vgg16=modify_vgg16(channel, im_size[0], num_classes)
    teacher_net=Vgg16(vgg16=vgg16).to(device)
    file_path = os.path.join(new_directory_path,'pretrained_net.pth')
    teacher_net.load_state_dict(torch.load(file_path))
    vgg16=modify_vgg16(channel, im_size[0], num_classes)
    student_net=Vgg16(vgg16=vgg16).to(device)
    starting_time = time.time()
    ...
    file_path = os.path.join(result_directory_path,'vgg_distillation_unlearning_stats.csv')
    df.to_csv(file_path, index=False)
    ...
    vgg16=modify_vgg16(channel, im_size[0], num_classes)
    bad_teacher_net=Vgg16(vgg16=vgg16).to(device)
    starting_time = time.time()
    ...
    file_path = os.path.join(result_directory_path,'vgg_bad_teacher_distillation_unlearning_stats.csv')
    df.to_csv(file_path , index=False)
    ...
    file_path = os.path.join(result_directory_path,'vgg_sparsification_unlearning_stats.csv')
    df.to_csv(file_path, index=False)
    ...
    file_path = os.path.join(result_directory_path,'vgg_prunning_unlearning_stats.csv')
    df.to_csv(file_path, index=False)
