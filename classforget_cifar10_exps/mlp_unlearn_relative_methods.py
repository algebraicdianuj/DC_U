...
from modular_unlearn.offline_training_mlp import *
...
def main():
    ...
    file_path = os.path.join(result_directory_path,'mlp_modular_unlearning_stats.csv')
    ...
    file_path = os.path.join(result_directory_path,'mlp_retraining_unlearning_stats.csv')
    df.to_csv(file_path, index=False)
    ...
    file_path = os.path.join(result_directory_path,'mlp_catastrophic_unlearning_stats.csv')
    df.to_csv(file_path, index=False)



    #-----------------------Distillation based Method---------------------------------------------------------------------------------
    teacher_net= MLP(input_size=channel * im_size[0] * im_size[1], hidden_size=hidden_size, output_size=num_classes).to(device)
    file_path = os.path.join(new_directory_path,'pretrained_net.pth')
    teacher_net.load_state_dict(torch.load(file_path))
    student_net= MLP(input_size=channel * im_size[0] * im_size[1], hidden_size=hidden_size, output_size=num_classes).to(device)
    starting_time = time.time()
    ...
    file_path = os.path.join(result_directory_path,'mlp_distillation_unlearning_stats.csv')
    df.to_csv(file_path, index=False)
    ...
    bad_teacher_net= MLP(input_size=channel * im_size[0] * im_size[1], hidden_size=hidden_size, output_size=num_classes).to(device)
    starting_time = time.time()
    ...
    file_path = os.path.join(result_directory_path,'mlp_bad_teacher_distillation_unlearning_stats.csv')
    df.to_csv(file_path , index=False)
    ...
    file_path = os.path.join(result_directory_path,'mlp_sparsification_unlearning_stats.csv')
    df.to_csv(file_path, index=False)
    ...
    file_path = os.path.join(result_directory_path,'mlp_prunning_unlearning_stats.csv')
    df.to_csv(file_path, index=False)
